<template>
  <div class="grid md:grid-cols-2 gap-4️">
    <div class="shadow-md bg-blue-100 p-10 m-2 text-center rounded">
    ...
    <div class="shadow-md bg-blue-200 p-10 m-2 text-center rounded">
